...
set1 = set(int(input('Введите ваши элементы: ')) for i in range(n))
print(f'Первое множество {set1}')
m = int(input('Введите количество элементов второго множества: '))
set2 = set(int(input('Введите ваши элементы: ')) for i in range(m))
print(f'Второе множество {set2}')
print('Числа, встречающиеся в обоих множествах: ', *sorted(set1 & set2), sep=' ')
'''
